...
CSV Export -> Select only Authors, 'Title, Year, Source title, Cited by, DOI, Link, Open Access' to export

```{r, include = FALSE}
scopus <- here("data-raw/scopus_lv.csv") |> 
  read_csv() |> 
  clean_names() |> 
  rename(
...
```{r, fig.cap="Source: https://www.scopus.com/authid/detail.uri?authorId=37056517000"}
scopus_tbl <- scopus |> 
  left_join(journal_q) |>
